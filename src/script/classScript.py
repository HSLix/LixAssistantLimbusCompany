...
class _mainScript(Thread):
    ...
    def __init__(self, LunacyToEnkephalin=0, EXPCount=0, ThreadCount=0, MirrorCount=0, InitSwitch=0, PrizeSwitch=0, MirrorSwitch=0, ActivityCount=0):
        '''构造函数'''
        ...
        self.exception = None
        self.exc_traceback = ''
        self.LunacyToEnkephalin = LunacyToEnkephalin
    ...
    def ScriptGameStart(self):
        ...
        # 签到点击
        afc.autoSinClick("./pic/initMenu/rewardsConfirm.png",
                         "Rewards Acquired")
        ...
        while(not afc.autoSinClick("./pic/initMenu/Window.png", "mainMenuSign")):
            ...
            if(afc.autoSinClick("./pic/battle/WinRate.png", "battleSign1") or
               afc.autoSinClick("./pic/battle/Start.png", "battleSign2")):
                ...
                getPic.winCap()
                afc.autoSinClick(
                    "./pic/mirror/mirror2/ego/SelectEGOGift.png", "SelectEGOGift", 0, 0, 6)
                loopCount = 0
            ...
            # 镜牢的情况
                ...
                getPic.winCap()
                afc.autoSinClick(
                    "./pic/mirror/mirror2/Confirm.png", "Confirm", 0, 0, 5)
                loopCount = 0
            # 在循环里必须有应对错误的情况
            self.errorRetry()
            getPic.winCap()

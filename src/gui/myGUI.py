...
class myGUI:
    ...
    def checkScreenScale(self):
        ...
        msg = "屏幕状况 (排除缩放后)宽x高 缩放： " + str(width) + " x " + \
            str(height) + " " + str(int(scale * 100)) + "%"
        myLog("debug", msg)
    ...
    def showAboutPageFrame(self):
        ...
        self.aboutPageFrame.place(width=700, height=650, x=1024, y=10)
    ...
    def setMainPageRightFrame(self):
        ...
        infoFrame = tk.LabelFrame(
            self.rightMainPageFrame, text="必读须知", padx=5, pady=5)
    ...
    def showLCATasks(self):
        ...
        tk.Label(self.taskFrame, text="狂气换脑啡肽",
                 font=("微软雅黑", 10),
                 justify="left",
                 anchor="w").place(width=180, height=20, x=0, y=515)
        self.LunacyToEnkephalinSet = ttk.Combobox(self.taskFrame)
        ...
        self.LunacyToEnkephalinSet.place(width=180, height=40, x=0, y=540)
